...
// Registered Courses are the one collection that must be shared across every
// signed-in user and survive refresh/logout/reopen on any device — so unlike
// the rest of the app's data (which stays on local storage, see
// loadSettings() below), courses are always read from and written straight
// to this Firestore database. Local storage is used only as an offline
